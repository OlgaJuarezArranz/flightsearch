 ...
 *                container. In our case, this class represent hibernate
 *                configuration.
 * @ComponentScan is equivalent to context:component-scan base-package="..." in
 *                xml, providing with where to look for spring managed
 *                beans/classes.
 ...
 *                 properties file in application classpath) in Spring run-time
 *                 Environment, providing flexibility to have different values
...
@ComponentScan({ "com.lastminute.configuration" })
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.lastminute.entities" });
